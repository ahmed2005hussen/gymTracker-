package com.ahmed.Hadidy.exercise.controller;
...
public class ExerciseController {
    ...
    @GetMapping(value = "/{exerciseId}" , version = "1.0")
    ...
    @DeleteMapping(value = "/{exerciseId}" , version = "1.0")
    ...
    @PatchMapping(value = "/{exerciseId}" , version = "1.0")
